...
import torch
from .h2stracker_vot import H2STracker
import samurai.votutils.vot_helper as vot
...
def main():
    ...
    config = "configs/him2sam/vot/sam2.1_hiera_l.yaml"

    print("Using config:", config)

    tracker = H2STracker(config)
