...
exp_name = "him2sam"
model_name = "large"
description='exp_him2sam_lasotext'
checkpoint = os.path.join(current_dir, f"../sam2/checkpoints/sam2.1_hiera_{model_name}.pt")
model_cfg = "configs/him2sam/lasotext/sam2.1_hiera_l.yaml"
video_folder= os.path.join(current_dir, "../data/LaSOT_extension_subset")
